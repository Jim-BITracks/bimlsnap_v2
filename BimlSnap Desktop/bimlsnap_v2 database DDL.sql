...
USE [bimlsnap_v2]
GO
/****** Object:  Schema [biml]    Script Date: 6/3/2019 3:32:03 PM ******/
CREATE SCHEMA [biml]
GO
/****** Object:  Schema [etl]    Script Date: 6/3/2019 3:32:03 PM ******/
CREATE SCHEMA [etl]
GO
/****** Object:  Schema [html]    Script Date: 6/3/2019 3:32:03 PM ******/
CREATE SCHEMA [html]
GO
/****** Object:  Schema [jtts]    Script Date: 6/3/2019 3:32:03 PM ******/
CREATE SCHEMA [jtts]
GO
/****** Object:  Schema [stg]    Script Date: 6/3/2019 3:32:03 PM ******/
CREATE SCHEMA [stg]
GO
/****** Object:  UserDefinedFunction [biml].[Adonet Connect String]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Adonet Provider]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Build Dim Merge (Standard snowflake)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [biml].[Build Dim Merge (Standard snowflake) Type 1 - Base Columns]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Build Dim Merge (Standard)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Build Dim Merge (Standard) Type 1 - Base Columns]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Build Environment Project Procedure]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Modify date: 
--
-- Description:	Generate a Stored Procedure to run a Project for an Environment
--
-- Sample Execute Command: 
/*	
SELECT [biml].[Build Environment Project Procedure]
	 (  'Sync LZ to ODS - Change Tracking'	-- @project_name
	  , ''								    -- @environment_name
	  , 'DDP - '							-- @sp_prefix_name
	  , 'DDP_DEV'							-- @ssis_catalog_folder
	  , 'dbo'								-- @schema_name
	  , 'False'								-- @use32bitruntime
	 ) 
*/
-- ================================================================================================

CREATE FUNCTION [biml].[Build Environment Project Procedure]
(
		@project_name			NVARCHAR(128)
	  , @environment_name		NVARCHAR(32)
	  , @sp_prefix_name			NVARCHAR(32)
	  , @ssis_catalog_folder	NVARCHAR(64)
	  , @schema_name			NVARCHAR(32)
	  , @use32bitruntime		NVARCHAR(5)
)
RETURNS NVARCHAR(MAX)
AS
BEGIN
...
DECLARE @sql VARCHAR(MAX)
	  ...
	  , @parameter_datatype NVARCHAR(32)
	  , @use_parameter_value NVARCHAR(512)

SET @sql = ' IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N''[' + @schema_name + '].[' + @sp_prefix_name + @project_name + ']'') AND type in (N''P'', N''PC''))
 DROP PROCEDURE [' + @schema_name + '].[' + @sp_prefix_name + @project_name + '];
 GO
 ...
 GO
 -- ================================================================================================
 -- Author:		 BimlSnap Generated
 -- Create date: ' + CONVERT(CHAR(10), GETDATE(),126) + '
 --
 -- Sample Execute Command: 
 /*	
 EXEC [' + @schema_name + '].[' + @sp_prefix_name + @project_name + ']
 */
 -- ================================================================================================

 CREATE PROCEDURE [' + @schema_name + '].[' + @sp_prefix_name + @project_name + ']
 AS
 DECLARE @execution_id BIGINT
 EXEC [SSISDB].[catalog].[create_execution] @package_name=N''Run All - ' + @project_name + '.dtsx'', @execution_id=@execution_id OUTPUT, @folder_name=N''' + @ssis_catalog_folder + ''', @project_name=N''' + @project_name + ''', @use32bitruntime=' + @use32bitruntime + ', @reference_id=NULL, @runinscaleout=False
 SELECT @execution_id
...
---------------------------------------------
-- Set All Project Parameters
---------------------------------------------
DECLARE [proc_cursor_param] CURSOR FOR  
SELECT p.[parameter_name]
	 , p.[parameter_datatype]
	 , COALESCE(ep.[parameter_value], p.[parameter_value]) AS [use_parameter_value]
  ...
  LEFT JOIN [biml].[project_environment] pe
	ON pe.[project_id] = pr.[project_id]
   AND pe.[environment_name] = @environment_name
  LEFT JOIN [biml].[environment_parameter] ep
    ON ep.[environment_name] = pe.[environment_name]
   AND ep.[parameter_name] = p.[parameter_name]
  WHERE [project_name] = @project_name ;
	    
OPEN [proc_cursor_param]   
FETCH NEXT FROM [proc_cursor_param] INTO @parameter_name, @parameter_datatype, @use_parameter_value
...
BEGIN 
 ...
 DECLARE @' + @parameter_name + ' ' + CASE WHEN @parameter_datatype = 'Boolean' THEN 'BIT' ELSE 'SQL_VARIANT' END + ' = ' + CASE WHEN @parameter_datatype = 'Boolean' THEN @use_parameter_value ELSE 'N''' + REPLACE(@use_parameter_value, '''', '''''') + '''' END + '
 EXEC [SSISDB].[catalog].[set_execution_parameter_value] @execution_id,  @object_type=20, @parameter_name=N''' + @parameter_name + ''', @parameter_value=@' + @parameter_name + '
 '
...
END
GO
/****** Object:  UserDefinedFunction [biml].[Build Fact Merge (Basic)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Build Fact Partition (Standard)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Build Fact Switch (Standard)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Build Fact Switch (Standard) jic]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Build Select Statement]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Build Select Statement (Direct)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Data Connect String]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Flatfile FileFormat]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Flatfile FilePath]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get user id]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get user name]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get version]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[is connection name used not adonet]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[is connection name used not flatfile]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[is connection name used not oledb]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[is connection name used not smtp]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Package Template (Group No Alerts)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Package Template (Group No Framework)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Package Template (Group)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Package Template (Run All No Alerts)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Package Template (Run All No Framework)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Package Template (Run All)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Package Template (Standard No Alerts)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Package Template (Standard No Framework)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Package Template (Standard)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[Smtp Connect String]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[DistinctHeader]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[Table DDL from CSV Header]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[package_config (CT Replication)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[package_config (Execute Script)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[package_config (Foreach Data Flow)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[package_config (Foreach Execute SQL)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[package_config (Data Flow)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[package_config (Execute SQL)]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[project]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[project_package]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[show packages using connection]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- ================================================================================================
-- Author:		Irhad Kunovac (BI Tracks Consulting, LLC)
-- Create date: 20 Jan 2019
-- Modify date: 
-- Description:	Get a list of packages that use a given connection
--
-- sample exec:
/*
SELECT * FROM [biml].[show packages using connection] ('SSIS_Data')
SELECT * FROM [biml].[show packages using connection] ('SMTP_Connection')
SELECT * FROM [biml].[show packages using connection] ('bimlsnap_v2')
*/
-- ================================================================================================

CREATE FUNCTION [biml].[show packages using connection] (@connection_name nvarchar(64))  
RETURNS TABLE  
AS  
RETURN   
(  
	SELECT [package_name]
	 ...
	 WHERE src_connection = @connection_name 
	    OR dst_connection = @connection_name
 UNION	
	SELECT [package_name]
	  FROM [biml].[package_config (Execute SQL)]
	 WHERE connection_manager = @connection_name
 UNION
	SELECT [package_name]
	  FROM [biml].[package_config (Foreach Data Flow)]
	 WHERE foreach_connection =  @connection_name 
	    OR src_connection = @connection_name 
		OR dst_connection = @connection_name
 UNION
	SELECT [package_name]
	  FROM [biml].[package_config (Foreach Execute SQL)]
	 WHERE foreach_connection =  @connection_name 
	    OR query_connection = @connection_name
 UNION
	SELECT [package_name]
 ...
 UNION
	SELECT pp.[package_name]
	 ...
	 WHERE p.[build_template_group] IN ('Standard', 'No Alerts')
	   AND @connection_name = 'SSIS_Data'
 UNION
	SELECT pp.[package_name]
	  FROM [biml].[project] p
	  JOIN [biml].[project_package] pp
		ON pp.[project_id] = p.[project_id]
	 WHERE p.[build_template_group] IN ('Standard')
	   AND @connection_name = 'SMTP_Connection'
);
GO
/****** Object:  Table [biml].[project_environment]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[show projects using environment]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Create date: 20 Jan 2019
-- Modify date: 
-- Description:	Get a list of projects that use a given environment
--
-- sample exec:
/*
SELECT * FROM [biml].[show projects using environment] ('VMWX03')
*/
-- ================================================================================================

CREATE FUNCTION [biml].[show projects using environment] (@environment_name nvarchar(32))  
RETURNS TABLE  
AS  
RETURN   
(  
	SELECT p.[project_name]
	  FROM [biml].[project] as p
	  JOIN [biml].[project_environment] as pe
	    ON p.[project_id] = pe.[project_id]
	 WHERE pe.[environment_name] = @environment_name
);
GO
/****** Object:  Table [biml].[environment_parameter]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[project_connection]    Script Date: 6/3/2019 3:32:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[project_parameter]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[show connections using environment]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Create date: 20 Jan 2019
-- Modify date: 
-- Description:	Get a list of connections that use a given environment
--
-- sample exec:
/*
SELECT * FROM [biml].[show connections using environment] ('VMWX03')
*/
-- ================================================================================================

CREATE FUNCTION [biml].[show connections using environment] (@environment_name nvarchar(32))  
RETURNS TABLE  
AS  
RETURN   
(  
	SELECT DISTINCT pc.[connection_name]
	  FROM [biml].[project_connection] as pc
	  JOIN [biml].[project_parameter] as p
	    ON replace(p.[parameter_name], '_server', '') = pc.[connection_name]
	  JOIN [biml].[environment_parameter] as ep
	    ON ep.[parameter_name] = p.[parameter_name]
	 WHERE p.[parameter_name] LIKE '%_Server' 
);
GO
/****** Object:  Table [biml].[package]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[pattern]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get packages]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get packages not in any project]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get packages not in project]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[parameter]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get parameters not in project]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[project_adonet_connection]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[adonet_connection]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get adonet connections not in project]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[project_flatfile_connection]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[flatfile_connection]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get flatfile connections not in project]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[package_config (Execute Process)]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[fact_table_partition_config (Standard)]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[fact_table_switch_config (Standard)]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[dim_table_merge_config (Standard)]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[fact_table_merge_config (Basic)]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get config tables for packages]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [etl].[dim_column]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[dim_column]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[get all column changes]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[project_smtp_connection]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[smtp_connection]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get smtp connections not in project]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[dim_table]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[get all insert and update dates]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get packages in project]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [etl].[dim_table]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[get all table changes]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [biml].[vw_package_biml]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[get all column changes by date]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Description:	Get all metadata column changes by date
--
-- sample exec:
/*
SELECT * FROM [dbo].[get all column changes by date] ('2018-03-05')
*/
-- ================================================================================================
CREATE FUNCTION [dbo].[get all column changes by date] (@date smalldatetime)  
RETURNS TABLE  
AS  
RETURN   
(  
...
GO
/****** Object:  UserDefinedFunction [dbo].[get all table changes by dates]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [biml].[vw_package_query]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[connection]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get data connections in project]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [biml].[vw_project_biml]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[show projects using parameter]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Create date: 20 Jan 2019
-- Modify date: 
-- Description:	Get a list of projects that use a given parameter
--
-- sample exec:
/*
SELECT * FROM [biml].[show projects using parameter] ('Force_Run_All')
SELECT * FROM [biml].[show projects using parameter] ('bimlsnap_v2_Server')
*/
-- ================================================================================================

CREATE FUNCTION [biml].[show projects using parameter] (@parameter_name nvarchar(128))  
RETURNS TABLE  
AS  
RETURN   
(  
	SELECT DISTINCT p.project_name
	  FROM [biml].[project] as p
	  JOIN [biml].[project_parameter] as pp
	    ON pp.project_id = p.project_id
	 WHERE pp.parameter_name = @parameter_name
);



GO
/****** Object:  UserDefinedFunction [biml].[show connections using parameter]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Create date: 20 Jan 2019
-- Modify date: 
-- Description:	Get a list of connections that use a given parameter
--
-- sample exec:
/*
SELECT * FROM [biml].[show connections using parameter] ('Force_Run_All')
SELECT * FROM [biml].[show connections using parameter] ('bimlsnap_v2_Server')
*/
-- ================================================================================================

CREATE FUNCTION [biml].[show connections using parameter] (@parameter_name nvarchar(128))  
RETURNS TABLE  
AS  
RETURN   
(  
	SELECT DISTINCT pc.connection_name
	 ...
	 WHERE p.[parameter_name] = @parameter_name
	   AND p.[parameter_name] LIKE '%_Server'
);
GO
/****** Object:  UserDefinedFunction [biml].[show projects which re-use package]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Author:		Irhad Kunovac (BI Tracks Consulting, LLC)
-- Create date: 20 Jan 2019
-- Modify date: 10 Apr 2019 - (MK) - remove where statement and show all packages
-- Modify date: 
-- Description:	Get a list of projects which re-use a given package
--
-- sample exec:
/*
SELECT * FROM [biml].[show projects which re-use package] ('Execute SQL - Delete DST Json Row')
SELECT * FROM [biml].[show projects which re-use package] ('Data Flow - Snowflake to SQL - stg.dim_database')
*/
-- ============================================================================================================

CREATE FUNCTION [biml].[show projects which re-use package] (@package_name nvarchar(128))  
RETURNS TABLE  
AS  
RETURN   
(  
	SELECT p.[project_name]
    FROM [biml].[project] as p
	JOIN [biml].[project_package] as pp
	ON p.[project_id] = pp.[project_id]
	WHERE pp.[package_name] = @package_name
	);

GO
/****** Object:  View [biml].[vw_project_connection]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get parameters in project]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get data connections not in project]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[environment]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[get environments not in project]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [biml].[show projects using connection]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- sample exec:
/*
SELECT * FROM [biml].[show projects using connection] ('SSIS_Data')
SELECT * FROM [biml].[show projects using connection] ('SMTP_Connection')
*/
-- ================================================================================================

CREATE FUNCTION [biml].[show projects using connection] (@connection_name nvarchar(64))  
RETURNS TABLE  
AS  
RETURN   
(  
	SELECT DISTINCT p.project_name
	  FROM [biml].[project] as p
	  JOIN [biml].[project_connection] as pc
	    ON pc.[project_id] = p.[project_id]
	 WHERE pc.[connection_name] = @connection_name
 UNION
	SELECT DISTINCT p.project_name
	  FROM [biml].[project] as p
	  JOIN [biml].[project_adonet_connection] as pc
	    ON pc.[project_id] = p.[project_id]
	 WHERE pc.[connection_name] = @connection_name
 UNION
	SELECT DISTINCT p.project_name
	  FROM [biml].[project] as p
	  JOIN [biml].[project_flatfile_connection] as pc
	    ON pc.[project_id] = p.[project_id]
	 WHERE pc.[connection_name] = @connection_name
 UNION
	SELECT DISTINCT p.project_name
	  FROM [biml].[project] as p
	  JOIN [biml].[project_smtp_connection] as pc
	    ON pc.[project_id] = p.[project_id]
	 WHERE pc.[connection_name] = @connection_name
);
GO
/****** Object:  Table [biml].[added_dim_column_names]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[application_config]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[build_log]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[column_alias]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[flatfile_format]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[package_config (Execute Process) variable]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[package_config (Execute Script) variable]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[package_config (Manual)]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[project_package_group]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[project_script_task]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[query_history]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[query_repository]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[script_task]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[sensitive_data]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[template]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[user]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [biml].[user_activity]    Script Date: 6/3/2019 3:32:04 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[application_error_log]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[application_error_log](
 ...
 CONSTRAINT [PK_dbo_application_error_log] PRIMARY KEY NONCLUSTERED 
(
	[log_id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [etl].[dim_database]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [etl].[dim_server]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [jtts].[json_repository]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [stg].[dim_column]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [stg].[dim_database]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [stg].[dim_table]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [biml].[project_package] ADD  CONSTRAINT [biml project_package sequence_number default]  DEFAULT ((-1)) FOR [sequence_number]
GO
ALTER TABLE [biml].[query_history] ADD  CONSTRAINT [biml query_history insert_datetime default]  DEFAULT (getdate()) FOR [insert_datetime]
GO
...
GO
/****** Object:  StoredProcedure [biml].[Auto Save Query History]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Build All Packages]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build All Projects]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build BIML Utility]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build Group and Run All Packages]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build Packages (CT Replication)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build Packages (Data Flow)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Modify date: 14 Feb 2019 - For AS400 - added [biml].[application_config] option for: "Data Flow Input ErrorHandling"
...
BEGIN
	...
	-- May need for AS400 connections -------------------------------------------------Begin ------
	DECLARE @ErrorHandling NVARCHAR(255);

	SELECT @ErrorHandling = [use_value]
      FROM [biml].[application_config]
	 WHERE [setting] = 'Data Flow Input ErrorHandling|' + @SrcConnection;

	SET @ErrorHandling = ISNULL(@ErrorHandling, '');
	-- May need for AS400 connections -------------------------------------------------End---------



	SET @DataflowInput = '<DirectInput>' + @SrcQuery + '</DirectInput>' + @ErrorHandling -- application_config
	...
	IF @IsExpression = 'Y' AND @connection_type = 'AdoNet'
		BEGIN
			...
			SET @DataflowInput = '<DirectInput>' + @SrcQueryDirect + '</DirectInput>' + @ErrorHandling -- application_config
		END
	ELSE
		BEGIN
			IF @IsExpression = 'Y'
				SET @DataflowInput = '<VariableInput VariableName="User.source_select" />' + @ErrorHandling -- application_config
		END
...
GO
/****** Object:  StoredProcedure [biml].[Build Packages (Data Flow) AS400]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build Packages (Execute Process)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build Packages (Execute Script)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build Packages (Execute SQL)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build Packages (Foreach Data Flow)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build Packages (Foreach Execute SQL)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build Packages (Manual)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build Parameters for Connections]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
VALUES
  ...
  , 'Finish');
GO
/****** Object:  StoredProcedure [biml].[Build Project Full]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build Project Parameters]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Build Single Project]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
EXEC [biml].[Save Query History]
GO
/****** Object:  StoredProcedure [biml].[Build Templates]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Modify date: 23 Jan 2019 - Added Isolation Level Option
-- Modify date: 19 Feb 2019 - Added Isolation Level Option - Bug Fix
...
/* set custom isolation level if configured */
DECLARE @IsolationLevel NVARCHAR(128)
	  , @ReplacementString NVARCHAR(128);

SELECT @IsolationLevel = [use_value] 
  FROM [biml].[application_config]
 WHERE [setting] = 'IsolationLevel';

IF @IsolationLevel IS NOT NULL
	BEGIN
		SET @ReplacementString = 'IsolationLevel="' + @IsolationLevel + '" ProtectionLevel='
	
		UPDATE [biml].[template]
		   SET [template_xml] = CAST(REPLACE(CAST([template_xml] AS NVARCHAR(MAX)), 'ProtectionLevel=', @ReplacementString) AS XML)
	END
...
GO
/****** Object:  StoredProcedure [biml].[Check Connection Name]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Clone Execute Process Package]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Clone Execute Script Package]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Clone Execute SQL Package]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Clone Project]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Delete Project]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Deleted Projects Clean Up]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Insert Dim Table Merge Config]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [biml].[Insert Environment]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert Execute Process Variable]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert Fact Table Merge Basic]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert Fact Table Partition Standard]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_NULLS ON
GO
/****** Object:  StoredProcedure [biml].[Insert Fact Table Switch Standard]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert or Update (Execute Script) Variable]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert or Update AdoNet Connection]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert or Update Connection]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert or Update Environment Parameter]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert or Update Flat Connection]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert or Update Flat File Column Alias]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert or Update Flat File Format]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert or Update Parameter]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert or Update SMTP Connection]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Insert Project Package Rows]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Primary Key Update (Data Flow)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Primary Key Update (Execute Process)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Primary Key Update (Execute Script)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Primary Key Update (Execute SQL)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Primary Key Update (Foreach Data Flow)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Author:		Ena Jukic (Software Developer)
-- Create date: 17 Oct 2017
-- Modify date: 10 May 2018 - Update PK change - update package name for all project
-- Modify date:  30 May 2018 - Fix source query direct character length
-- Modify date:  
...
END
GO
/****** Object:  StoredProcedure [biml].[Primary Key Update (Foreach Execute SQL)]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Register User]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [biml].[Save Query History]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Update Merge Statements]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Update Partition Statements]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Update Sensitive Data Placeholders]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [biml].[Update Switch Statements]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Change Server Name in Metadata]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Delete Server Metadata]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT @rows AS [row_count];
GO
/****** Object:  StoredProcedure [etl].[Reset Metadata]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Modify date: 17 Aug 2018 - added 'Full Metadata Reset' in comments below
--
-- Description:	Resets merge_type columns for the currrent database
--
-- Sample Execute Commands: 
/*
EXEC [etl].[Reset Metadata]
*/
-- ================================================================================================
CREATE PROCEDURE [etl].[Reset Metadata]
...
--  Full Metadata Reset
/*
TRUNCATE TABLE [dbo].[dim_column]
TRUNCATE TABLE [dbo].[dim_table]
TRUNCATE TABLE [etl].[dim_column]
TRUNCATE TABLE [etl].[dim_database]
TRUNCATE TABLE [etl].[dim_server]
TRUNCATE TABLE [etl].[dim_table]
TRUNCATE TABLE [stg].[dim_column]
TRUNCATE TABLE [stg].[dim_database]
TRUNCATE TABLE [stg].[dim_table]
*/
GO
/****** Object:  StoredProcedure [html].[Output Package Query File v2]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Modified:	01 Feb 2019 (JMM) - Bug Fix with NULL [Package Query]
-- Modified:	
...
SELECT DISTINCT pk.[package_name] AS [Package Name]
	 ...
	 , COALESCE(ctr.[dst_sync_query], df.[src_query], 'Executable: ' + ep.[executable_expr] 
	   ...
	   + CHAR(13) + CHAR(10) + CHAR(13) + CHAR(10) + 'Working Directory: ' + ep.[working_directory], 'Script Name: ' + escr.[script_name] , es.[query], fedf.[src_query_expr], fees.[query], '! NOT FOUND !') AS [Package Query]
  FROM [biml].[pattern] pt
  JOIN [biml].[package] pk
	ON pk.[pattern_name] = pt.[pattern_name]
  JOIN [biml].[project_package] pp
...
SELECT @Html;
GO
/****** Object:  StoredProcedure [html].[Output Query as Table]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [jtts].[Insert Into JSON Repository]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- ================================================================================================
-- Author:		Ehlimana Krupalija (Software Developer)
-- Create date: 23 May 2019
-- Modify date: 
--
-- Description:	Loading specified JSON file into the database
-- Sample Execute Command: 
/*
EXEC [jtts].[Load JSON File] 'label', 'server_name', 'database_name', 'label_notes', 'json_file'
*/
-- ================================================================================================

CREATE PROCEDURE [jtts].[Insert Into JSON Repository]
	(
		 @label NVARCHAR(16),
		 @server_name NVARCHAR(128),
		 @database_name NVARCHAR(128),
		 @label_notes NVARCHAR(3000),
		 @json_file NVARCHAR(300)--,
...
EXEC [jtts].[Load JSON File] @label, @server_name, @database_name, @label_notes, @json_file, @t OUTPUT
SELECT @t AS [@json_file]

EXEC [jtts].[Json Table Import] '', 'Y', 'N', 'N', '', 'N', @label, @server_name, @database_name;

END
GO
/****** Object:  StoredProcedure [jtts].[Json Project Import]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- ================================================================================================
-- Author:		Laurie Ukpabi (BITracks Consulting, LLC)
-- Create date: 16 Nov 2018 - Start
-- Modify date: 22 Feb 2019 - Finish (JMM)
-- Modify date: 
--
-- Description:	Imports a single project from a Json file into the current database
-- Sample Execute Command: 
/*
EXEC [jtts].[Json Project Import] 'Metadata Refresh v2', 'All_Projects', 'PC7', 'bimlsnap_v2'
EXEC [jtts].[Json Project Import] 'Metadata Refresh v2 (Snowflake)', 'All_Projects', 'PC7', 'bimlsnap_v2'
EXEC [jtts].[Json Project Import] 'Transfer Json Repository File', 'All_Projects', 'SRV4\S04', 'bimlsnap_v2'
EXEC [jtts].[Json Project Import] 'Transfer and Load Repository File', 'All_Projects', 'SRV4\S04', 'bimlsnap_v2'
*/
-- ================================================================================================

CREATE PROCEDURE [jtts].[Json Project Import]
	(
		 @load_project_name NVARCHAR(128)
	   , @json_label NVARCHAR(16)
	   , @json_server_name NVARCHAR(128)
	   , @json_database_name  NVARCHAR(128)
	)
AS
...
IF ISNULL(@load_project_name, '') = ''
	BEGIN
		SET @error_message = 'Must provide parameter: @load_project_name'
		SELECT @return_code AS [return code], @error_message AS [error message]
		RETURN
	END

IF ISNULL(@json_label, '') = ''
	BEGIN
		SET @error_message = 'Must provide parameter: @json_label'
		SELECT @return_code AS [return code], @error_message AS [error message]
		RETURN
	END

IF ISNULL(@json_server_name, '') = ''
	BEGIN
		SET @error_message = 'Must provide parameter: @json_server_name'
		SELECT @return_code AS [return code], @error_message AS [error message]
		RETURN
	END

IF ISNULL(@json_database_name, '') = ''
	BEGIN
		SET @error_message = 'Must provide parameter: @json_database_name'
		SELECT @return_code AS [return code], @error_message AS [error message]
		RETURN
	END
...
/* get list of needed tables to replicate in ##Temp tables */
...
( 
'[biml].[application_config]', 
'[biml].[build_log]', 
'[biml].[pattern]', 
'[biml].[query_repository]',
'[biml].[sensitive_data]', 
'[biml].[template]', 
'[biml].[user]', 
'[biml].[user_activity]', 
...
SELECT @load_create_datetime = [create_datetime]
 ...
 WHERE [label] = @json_label
   AND [server_name] = @json_server_name
   AND [database_name] = @json_database_name
...
DELETE @table_not_found;
		...
		/* Verify all JSON based tables exist as a destination table */
...
/* 
	Json IMPORT Code - Iterate through import_table and populate ##global_temp table for each table row 
*/
 ...
 SELECT t.[schema_name], t.[table_name], t.[schema_result_set]
  ...
  WHILE @@FETCH_STATUS = 0
	...
	IF @IdentityInsertColumnSum > 0
		...
		DROP TABLE IF EXISTS ##' + @SchemaName + '__' + REPLACE(REPLACE(REPLACE(@TableName, ' ', '_'), '(', ''), ')', '') + '
		SELECT * INTO ##' + @SchemaName + '__' + REPLACE(REPLACE(REPLACE(@TableName, ' ', '_'), '(', ''), ')', '') + ' FROM  OPENJSON ( @json ) WITH (' + @WithSTR + '       ) rc ;'
...
/*
SELECT * FROM ##biml__added_dim_column_names;
SELECT * FROM ##biml__adonet_connection;
SELECT * FROM ##biml__column_alias;
SELECT * FROM ##biml__connection;
SELECT * FROM ##biml__dim_table_merge_config_Standard;
SELECT * FROM ##biml__environment;
SELECT * FROM ##biml__environment_parameter;
SELECT * FROM ##biml__fact_table_merge_config_Basic;
SELECT * FROM ##biml__fact_table_partition_config_Standard;
SELECT * FROM ##biml__fact_table_switch_config_Standard;
SELECT * FROM ##biml__flatfile_connection;
SELECT * FROM ##biml__flatfile_format;
SELECT * FROM ##biml__package;
SELECT * FROM ##biml__package_config_CT_Replication;
SELECT * FROM ##biml__package_config_Data_Flow;
SELECT * FROM ##biml__package_config_Execute_Process;
SELECT * FROM ##biml__package_config_Execute_Process_variable;
SELECT * FROM ##biml__package_config_Execute_Script;
SELECT * FROM ##biml__package_config_Execute_Script_variable;
SELECT * FROM ##biml__package_config_Execute_SQL;
SELECT * FROM ##biml__package_config_Foreach_Data_Flow;
SELECT * FROM ##biml__package_config_Foreach_Execute_SQL;
SELECT * FROM ##biml__package_config_Manual;
SELECT * FROM ##biml__parameter;
SELECT * FROM ##biml__project;
SELECT * FROM ##biml__project_adonet_connection;
SELECT * FROM ##biml__project_connection;
SELECT * FROM ##biml__project_environment;
SELECT * FROM ##biml__project_flatfile_connection;
SELECT * FROM ##biml__project_package;
SELECT * FROM ##biml__project_package_group;
SELECT * FROM ##biml__project_parameter;
SELECT * FROM ##biml__project_script_task;
SELECT * FROM ##biml__project_smtp_connection;
SELECT * FROM ##biml__query_history
SELECT * FROM ##biml__script_task;
SELECT * FROM ##biml__smtp_connection;
SELECT * FROM ##etl__dim_column;
SELECT * FROM ##etl__dim_database;
SELECT * FROM ##etl__dim_server;
SELECT * FROM ##etl__dim_table;
*/
...
DECLARE @project_id_json INT = (SELECT [project_id] 
								  FROM ##biml__project 
								 WHERE [project_name] = @load_project_name);

IF ISNULL(@project_id_json, '') = ''
	BEGIN
		SET @error_message = 'Project ID Not Found in ##biml__project'
		SELECT @return_code AS [return code], @error_message AS [error message]
		RETURN
	END
...
------Delete Project if it exists----
				...
				EXEC [biml].[Delete Project] @load_project_name
...
------Get new project id from project table----

	DECLARE @project_id INT = (SELECT [project_id] FROM [biml].[project] WHERE [project_name] = @load_project_name);


------Insert into [project_adonet_connection]----

				INSERT INTO [biml].[project_adonet_connection]
						   ([project_id]
						   ,[connection_name])

				SELECT @project_id
					, [connection_name] 
				FROM ##biml__project_adonet_connection
				WHERE project_id = @project_id_json


---------Insert into [adonet_connection]------
			INSERT INTO [biml].[adonet_connection]
					   ([connection_name]
					   ,[provider]
					   ,[connect_string]
				...
				SELECT ac.[connection_name]
						   ,ac.[provider]
						   ,ac.[connect_string]
						   ,ac.[database_name] 
					FROM ##biml__adonet_connection ac
						 JOIN ##biml__project_adonet_connection pac ON ac.connection_name = pac.connection_name
							WHERE pac.project_id = @project_id_json					
				     AND NOT EXISTS ( SELECT 1 FROM [biml].[adonet_connection] acc WHERE acc.[connection_name] = ac.[connection_name] )


--------------Insert into [project_connection]---

				INSERT INTO [biml].[project_connection]
						   ([project_id]
						   ,[connection_name])

				SELECT @project_id, [connection_name] 
				FROM ##biml__project_connection
				WHERE project_id = @project_id_json
...
------------- Insert into [connection]---
				...
				INSERT INTO [biml].[connection]
				  ...
				  SELECT c.[connection_name]
					   ...
					   , c.[database_name]
					   , c.[provider]
					   , c.[custom_connect_string]
					FROM ##biml__connection c
					JOIN ##biml__project_connection pc 
					  ON c.connection_name = pc.connection_name
				   WHERE pc.project_id = @project_id_json
				     AND NOT EXISTS ( SELECT 1 FROM [biml].[connection] cc WHERE cc.[connection_name] = c.[connection_name] )
...
--------------Insert into [environment]
				...
				SELECT e.[environment_name]
					FROM ##biml__environment e
						 JOIN ##biml__project_environment pe ON e.[environment_name] = pe.[environment_name]
							WHERE pe.project_id = @project_id_json
...
----------------Insert into [project_environment]--------
				...
				SELECT @project_id
					...
					,[build_datetime]
					,[build_template_group]
				FROM ##biml__project_environment
				WHERE project_id = @project_id_json


----------------Insert into [environment_parameter]--------
				...
				INSERT INTO [biml].[environment_parameter]
					...
					SELECT ep.[environment_name]
						 , ep.[parameter_name]
						 , ep.[parameter_value]
					FROM ##biml__environment_parameter ep
					JOIN ##biml__project_environment pe
					  ON pe.[environment_name] = ep.[environment_name]
					WHERE pe.[project_id] = @project_id_json
					  AND NOT EXISTS ( SELECT 1 FROM [biml].[environment_parameter] epp 
										WHERE epp.[environment_name] = ep.[environment_name] 
										  AND epp.[parameter_name] = ep.[parameter_name] )
		

---------------Insert into [project_smtp_connection]

				INSERT INTO [biml].[project_smtp_connection]
						   ([project_id]
						   ,[connection_name])

				SELECT @project_id
					, [connection_name] 
				FROM ##biml__project_smtp_connection
				WHERE project_id = @project_id_json


---------------Insert into smtp connection

				INSERT INTO [biml].[smtp_connection]
						   ([connection_name]
						   ,[server_name])

				SELECT sc.[connection_name]
				     , sc.[server_name]
				  FROM ##biml__smtp_connection sc
				  JOIN ##biml__project_smtp_connection psc	
				    ON sc.[connection_name] = psc.[connection_name]		 
				 WHERE psc.project_id = @project_id_json
				   AND NOT EXISTS ( SELECT 1 FROM [biml].[smtp_connection] scc WHERE scc.[connection_name] = sc.[connection_name] )


---------------Insert into [project_flatfile_connection]

				INSERT INTO [biml].[project_flatfile_connection]
						   ([project_id]
						   ,[connection_name])

				SELECT @project_id
					,[connection_name]
				FROM ##biml__project_flatfile_connection
				WHERE project_id = @project_id_json


-------------Insert into [flatfile_connection]
		...
		INSERT INTO [biml].[flatfile_connection]
		     ...
		     SELECT ff.[connection_name]
				  , ff.[file_path]
				  , ff.[file_format]
			   FROM ##biml__flatfile_connection ff
			   JOIN ##biml__project_flatfile_connection pff 
			     ON ff.[connection_name] = pff.[connection_name]
			  WHERE pff.project_id = @project_id_json
			    AND NOT EXISTS ( SELECT 1 FROM [biml].[flatfile_connection] ffc WHERE ffc.[connection_name] = ff.[connection_name] )


-------------Insert into [flatfile_format]
			...
			INSERT INTO [biml].[flatfile_format]
			       ...
			       SELECT fm.[file_format]
					    , fm.[code_page]
					    , fm.[column_delimiter]
					    , fm.[row_delimiter]
					    , fm.[text_qualifer]
					    , fm.[ColumnNamesInFirstDataRow]
					    , fm.[IsUnicode]
					    , fm.[metadata_server]
					    , fm.[metadata_database]
					    , fm.[metadata_schema]
					    , fm.[metadata_table]
					 FROM ##biml__flatfile_format fm
					 JOIN ##biml__flatfile_connection fc	
					   ON fc.[file_format] = fm.[file_format]
					 JOIN ##biml__project_flatfile_connection pfc 
					   ON fc.[connection_name] = pfc.[connection_name]
					WHERE pfc.project_id = @project_id_json
					  AND NOT EXISTS ( SELECT 1 FROM [biml].[flatfile_format] fff WHERE fff.[file_format] = fm.[file_format] )
...
-------------Insert into [project_package]
				...
				SELECT @project_id
						,[sequence_number]
						,[package_name]
				FROM ##biml__project_package
				WHERE project_id = @project_id_json


----------------Insert into [package]

				INSERT INTO [biml].[package]
						   ([package_name]
						   ,[pattern_name]
						   ,[package_text]
						   ,[package_xml]
				...
				SELECT p.[package_name]
					 ...
					 , '' AS [package_text]
					 , '' AS [package_xml]
					 , '1900-01-01' AS [build_datetime]
					 , p.[build_template]
				  FROM ##biml__package p
				  JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
				 WHERE pp.project_id = @project_id_json
				   AND NOT EXISTS ( SELECT 1 FROM [biml].[package] cep WHERE cep.[package_name] = p.[package_name] )
					

-----------------Insert into [project_package_group]
				...
				INSERT INTO [biml].[project_package_group]
					...
					SELECT @project_id
						,[sequence_number]
						,[package_name]
				FROM ##biml__project_package_group
				WHERE project_id = @project_id_json
...
-----------------Insert into [parameter]
				...
				SELECT p.[parameter_name]
						   ,p.[parameter_datatype]
						   ,p.[parameter_value]
					FROM ##biml__parameter p
					JOIN ##biml__project_parameter pp ON p.[parameter_name] = pp.[parameter_name]
				   WHERE pp.project_id = @project_id_json
				     AND NOT EXISTS ( SELECT 1 FROM [biml].[parameter] pp WHERE pp.[parameter_name] = p.[parameter_name] )


-----------------Insert into [project_script_task]

				INSERT INTO [biml].[project_script_task]
						   ([project_id]
						   ,[script_name])

					SELECT @project_id
						,[script_name]
				FROM ##biml__project_script_task
				WHERE project_id = @project_id_json


-----------------Insert into [script_task]

				INSERT INTO [biml].[script_task]
						   ([script_name]
						   ,[script_text])

					SELECT s.[script_name]
						 , s.[script_text]
					  FROM ##biml__script_task s
					  JOIN ##biml__project_script_task ps 
					    ON s.[script_name] = ps.[script_name]
					 WHERE ps.project_id = @project_id_json
					   AND NOT EXISTS ( SELECT 1 FROM [biml].[script_task] st WHERE st.[script_name] = s.[script_name] )


--------------INSERT [package_config (CT Replication)]

				INSERT INTO [biml].[package_config (CT Replication)]
						   ([package_qualifier]
						   ,[src_connection]
						   ,[src_deletes_query_expr]
						   ,[src_inserts_query_expr]
				...
				SELECT pc.[package_qualifier]
						   ,pc.[src_connection]
						   ,pc.[src_deletes_query_expr]
						   ,pc.[src_inserts_query_expr]
						   ,pc.[dst_connection]
						   ,pc.[dst_sync_query]
						   ,pc.[sync_schema]
						   ,pc.[target_table]
						   ,pc.[use_identity_insert]
				FROM ##biml__package_config_CT_Replication pc
					JOIN ##biml__package p	ON p.[package_name] = ((('CT Replication - '+pc.[package_qualifier])+' - ')+pc.[target_table])
					JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
							WHERE pp.project_id = @project_id_json

					AND NOT EXISTS ( SELECT 1 FROM [biml].[package_config (CT Replication)] rpc 
										WHERE rpc.[package_qualifier] = pc.[package_qualifier] 
										  AND rpc.[target_table]      = pc.[target_table] )


---------------------INSERT [package_config (Execute Process)]
				...
				SELECT pe.[package_qualifier]
						   ,pe.[executable_expr]
						   ,pe.[arguments_expr]
						   ,pe.[working_directory]
						   ,pe.[place_values_in_SSIS_Data]
				FROM ##biml__package_config_Execute_Process pe
				JOIN ##biml__package p	ON p.[package_name] = ('Execute Process - '+pe.[package_qualifier])
				JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
				WHERE pp.project_id = @project_id_json

				AND NOT EXISTS ( SELECT 1 FROM [biml].[package_config (Execute Process)] rpe WHERE rpe.[package_qualifier] = pe.[package_qualifier] )


---------------------------------------EXECUTE PROCESS VARIABLE
				...
				INSERT INTO [biml].[package_config (Execute Process) variable]
					...
					SELECT pev.[package_qualifier]
						   ,pev.[Name]
						   ,pev.[DataType]
						   ,pev.[EvaluateAsExpression]
						   ,pev.[variable_value]
					FROM ##biml__package_config_Execute_Process_variable pev
					JOIN ##biml__package_config_Execute_Process pe	ON pev.[package_qualifier] = pe.[package_qualifier]
					JOIN ##biml__package p	ON p.[package_name] = ('Execute Process - '+pe.[package_qualifier])
					JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
							WHERE pp.project_id = @project_id_json

				AND NOT EXISTS ( SELECT 1 FROM [biml].[package_config (Execute Process) variable] rpev 
										WHERE rpev.[package_qualifier] = pev.[package_qualifier] 
										  AND rpev.[Name]              = pev.[Name] )


-----------------------INSERT [package_config (Execute Script)]
				...
				SELECT ps.[connection_manager]
						   ,ps.[script_name]
						   ,ps.[package_qualifier]
						   ,ps.[return_row_count]
				FROM ##biml__package_config_Execute_Script ps
				JOIN ##biml__package p	ON p.[package_name] = ('Execute Script - '+ps.[package_qualifier])
				JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
				WHERE pp.project_id = @project_id_json

				AND NOT EXISTS ( SELECT 1 FROM [biml].[package_config (Execute Script)] rps WHERE rps.[package_qualifier] = ps.[package_qualifier] )


----------------------------[package_config (Execute Script) variable]--------------------------------
				...
				INSERT INTO [biml].[package_config (Execute Script) variable]
					...
					SELECT psv.[package_qualifier]
						   ,psv.[Name]
						   ,psv.[DataType]
						   ,psv.[EvaluateAsExpression]
						   ,psv.[variable_value]
					FROM ##biml__package_config_Execute_Script_variable psv
					JOIN ##biml__package_config_Execute_Script ps	ON psv.[package_qualifier] = ps.[package_qualifier]
					JOIN ##biml__package p	ON p.[package_name] = ('Execute Script - '+ps.[package_qualifier])
					JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
							WHERE pp.project_id = @project_id_json

				AND NOT EXISTS ( SELECT 1 FROM [biml].[package_config (Execute Script) variable] rpsv 
										WHERE rpsv.[package_qualifier] = psv.[package_qualifier] 
										  AND rpsv.[Name]              = psv.[Name] )


---------------------INSERT [package_config (Execute SQL)]
				...
				SELECT sq.[connection_manager]
						   ,sq.[package_qualifier]
						   ,sq.[query]
						   ,sq.[is_expression]
						   ,sq.[return_row_count]
				FROM ##biml__package_config_Execute_SQL sq
					JOIN ##biml__package p	ON p.[package_name] = ('Execute SQL - '+sq.[package_qualifier])
					JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
					WHERE pp.project_id = @project_id_json

					AND NOT EXISTS ( SELECT 1 FROM [biml].[package_config (Execute SQL)] rsq WHERE rsq.[package_qualifier] = sq.[package_qualifier] )


---------------------------INSERT [package_config (Foreach Data Flow)]
				...
				SELECT fd.[foreach_connection]
						   ,fd.[foreach_query_expr]
						   ,fd.[foreach_item_datatype]
						   ,fd.[foreach_item_build_value]
						   ,fd.[src_connection]
						   ,fd.[src_query_expr]
						   ,fd.[src_query_direct]
						   ,fd.[package_qualifier]
						   ,fd.[dst_connection]
						   ,fd.[dst_schema]
						   ,fd.[dst_table]
						   ,fd.[dst_truncate]
						   ,fd.[keep_identity]
				FROM ##biml__package_config_Foreach_Data_Flow fd
					JOIN ##biml__package p	ON p.[package_name] = ((('Foreach Data Flow - '+fd.[package_qualifier])+' - ')+fd.[dst_table])
					JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
							WHERE pp.project_id = @project_id_json

				AND NOT EXISTS ( SELECT 1 FROM [biml].[package_config (Foreach Data Flow)] rfd 
										 WHERE rfd.[package_qualifier] = fd.[package_qualifier] 
										   AND rfd.[dst_table]         = fd.[dst_table] )


--------------------Insert [package_config (Data Flow)]--------------
				...
				INSERT INTO [biml].[package_config (Data Flow)]
				 ...
				 SELECT df.[src_connection]
						   ,df.[src_query]
						   ,df.[is_expression]
						   ,df.[src_query_direct]
						   ,df.[package_qualifier]
						   ,df.[dst_connection]
						   ,df.[dst_schema]
						   ,df.[dst_table]
						   ,df.[dst_truncate]
						   ,df.[keep_identity]
				FROM ##biml__package_config_Data_Flow df
					JOIN ##biml__package p	ON p.[package_name] = (('Data Flow - '+df.[package_qualifier])+case when df.[dst_table]='' then '' else ((' - '+df.[dst_schema])+'.')+df.[dst_table] end)
					JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
							WHERE pp.project_id = @project_id_json

				AND NOT EXISTS ( SELECT 1 FROM [biml].[package_config (Data Flow)] rdf 
										 WHERE rdf.[package_qualifier] = df.[package_qualifier] 
										   AND rdf.[dst_schema]        = df.[dst_schema] 
										   AND rdf.[dst_table]         = df.[dst_table] )


---------------------[package_config (Manual)]

				INSERT INTO [biml].[package_config (Manual)]
						   ([package_qualifier])

				SELECT [package_qualifier]
				FROM ##biml__package_config_Manual pcm
					JOIN ##biml__package p	ON p.[package_name] =  ('Manual - '+pcm.[package_qualifier])
					JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
							WHERE pp.project_id = @project_id_json
...
------------------------------------[package_config (Foreach Execute SQL)]
				...
				SELECT
						[package_qualifier]
						   ...
						   ,[is_expression]
						   ,[return_row_count]
				FROM ##biml__package_config_Foreach_Execute_SQL fsq
					JOIN ##biml__package p	ON p.[package_name] =  ('Foreach Execute SQL - '+fsq.[package_qualifier])
					JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
					WHERE pp.project_id = @project_id_json

					AND NOT EXISTS ( SELECT 1 FROM [biml].[package_config (Foreach Execute SQL)] rfsq WHERE rfsq.[package_qualifier] = fsq.[package_qualifier] )


--------------------------------[fact_table_partition_config (Standard)]
				...
				SELECT pcs.[partition_scheme]
						   ,pcs.[partition_function]
						   ,pcs.[days_ahead]
						   ,pcs.[day_partitions]
						   ,pcs.[month_partitions]
						   ,pcs.[quarter_partitions]
						   ,pcs.[year_partitions]
						   ,pcs.[switch_in_schema_name]
						   ,pcs.[switch_in_table_name]
						   ,pcs.[truncate_switch_in_table]
						   ,pcs.[package_qualifier]
					FROM ##biml__fact_table_partition_config_Standard pcs
						JOIN ##biml__package_config_Execute_SQL sq	ON pcs.[package_qualifier] = sq.[package_qualifier]
						JOIN ##biml__package p	ON p.[package_name] = ('Execute SQL - '+sq.[package_qualifier])
						JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
								WHERE pp.project_id = @project_id_json
	
				AND NOT EXISTS ( SELECT 1 FROM [biml].[fact_table_partition_config (Standard)] rpcs 
										 WHERE rpcs.[partition_scheme]   = pcs.[partition_scheme]
										   AND rpcs.[partition_function] = pcs.[partition_function] )


--------------------------------------------------------------------------[fact_table_switch_config (Standard)]
				...
				SELECT scs.[src_schema_name]
						   ,scs.[src_table_name]
						   ,scs.[dst_schema_name]
						   ,scs.[dst_table_name]
						   ,scs.[out_schema_name]
						   ,scs.[out_table_name]
						   ,scs.[package_qualifier]
						   ,scs.[switch_option]
						   ,scs.[project_parameter]
					FROM ##biml__fact_table_switch_config_Standard scs
						JOIN ##biml__package_config_Execute_SQL sq	ON scs.[package_qualifier] = sq.[package_qualifier]
						JOIN ##biml__package p	ON p.[package_name] = ('Execute SQL - '+sq.[package_qualifier])
						JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
								WHERE pp.project_id = @project_id_json

					AND NOT EXISTS ( SELECT 1 FROM [biml].[fact_table_switch_config (Standard)] rscs 
										 WHERE rscs.[src_schema_name]  = scs.[src_schema_name]
										   AND rscs.[src_table_name]   = scs.[src_table_name] );


-------------------------------------------------[biml].[dim_table_merge_config (Standard)]

				WITH [dim_table_merge_config__inserts] AS
				(
					SELECT mcs.[stg_server]
						   ,mcs.[stg_database]
						   ,mcs.[stg_schema]
						   ,mcs.[dst_schema]
						   ,mcs.[stg_table]
						   ,mcs.[dst_table]
						   ,mcs.[stg_database_param_name]
						   ,mcs.[dst_database_param_name]
						   ,mcs.[package_qualifier]
						   ,mcs.[added_dim_column_names_id]
					FROM ##biml__dim_table_merge_config_Standard mcs
						JOIN ##biml__package_config_Execute_SQL sq	ON mcs.[package_qualifier] = sq.[package_qualifier]
						JOIN ##biml__package p	ON p.[package_name] = ('Execute SQL - '+sq.[package_qualifier])
						JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
								WHERE pp.project_id = @project_id_json
				...
				SELECT * 
				  INTO #dim_table_merge_config__inserts
				  FROM [dim_table_merge_config__inserts];
...
-----------------------------------------[biml].[fact_table_merge_config (Basic)]
				...
				SELECT mcb.[stg_server]
						   ...
						   ,mcb.[stg_table]
						   ,mcb.[dst_table]
						   ,mcb.[package_qualifier]
					FROM ##biml__fact_table_merge_config_Basic mcb
						JOIN ##biml__package_config_Execute_SQL sq	ON mcb.[package_qualifier] = sq.[package_qualifier]
						JOIN ##biml__package p	ON p.[package_name] = ('Execute SQL - '+sq.[package_qualifier])
						JOIN ##biml__project_package pp ON p.[package_name] = pp.[package_name]
						WHERE pp.project_id = @project_id_json

						  AND NOT EXISTS ( SELECT 1 FROM [biml].[fact_table_merge_config (Basic)] rmcb WHERE rmcb.[package_qualifier] = mcb.[package_qualifier] )


---------------------------------------------------------[added_dim_column_names]


	IF EXISTS (SELECT 1 FROM #dim_table_merge_config__inserts)
	BEGIN

		WITH [missing_added_dim_column_names_rows] AS
		(
				SELECT adc.* FROM ##biml__added_dim_column_names adc	
                  JOIN ##biml__dim_table_merge_config_Standard dtms  -- only import if used
				    ON dtms.[added_dim_column_names_id] = adc.[added_dim_column_names_id]
			EXCEPT
				SELECT * 
				  FROM [biml].[added_dim_column_names]
		)
		SELECT *
		  INTO #missing_added_dim_column_names_rows
		  FROM [missing_added_dim_column_names_rows]

		  IF EXISTS (SELECT 1 FROM #missing_added_dim_column_names_rows)
		  BEGIN
				BEGIN TRY
						INSERT INTO [biml].[added_dim_column_names]
						  ...
						  SELECT  LEFT(adc.[added_dim_column_names_tag] + '(' + CAST(adc.[added_dim_column_names_id] AS varchar) + ')', 16) AS [added_dim_column_names_tag]
								   ,adc.[row_is_current]
								   ,adc.[row_effective_date]
								   ,adc.[row_expiration_date]
								   ,adc.[row_insert_date]
								   ,adc.[row_update_date]
							FROM #missing_added_dim_column_names_rows

					PRINT 'Warning - Inserted Rows in table: [biml].[added_dim_column_names] probably have different value for column: [added_dim_column_names_id]. As a result, related rows in table: [biml].[dim_table_merge_config (Standard)] may need this same column name [added_dim_column_names_id] updated with the new id.'
				END TRY
				BEGIN CATCH
					PRINT 'Warning - One or more Inserts into table: [biml].[added_dim_column_names] failed. Be sure to examine this table, and the table: [biml].[dim_table_merge_config (Standard)] which are related by column name [added_dim_column_names_id].'
				END CATCH
			END

		DROP TABLE #missing_added_dim_column_names_rows;
...
---------------------------------------------------------[etl].[dim_server]
		...
		INSERT INTO [etl].[dim_server]
			...
			SELECT [server_name]
				  ,[server_type]
				  ,[comments]
			  FROM ##etl__dim_server ds
			 WHERE NOT EXISTS
				 ( SELECT 1
				     FROM [etl].[dim_server]							-- skip if already defined
					WHERE [server_name] = ds.[server_name]
				 )
			   AND EXISTS
				 ( SELECT 1
				     FROM ##biml__dim_table_merge_config_Standard dtms  -- only import if used
					WHERE dtms.[stg_server] = ds.[server_name]
				 )


---------------------------------------------------------[etl].[dim_database]

		INSERT INTO [etl].[dim_database]
				   ([server_name]
				   ,[database_name]
			...
			SELECT [server_name]
				  ...
				  ,[extract_metadata]
				  ,[staging_database]
			  FROM ##etl__dim_database dd
			 WHERE NOT EXISTS
				 ( SELECT 1
				     FROM [etl].[dim_database]
					WHERE [server_name] = dd.[server_name]
					  AND [database_name] = dd.[database_name]
				 )
			   AND EXISTS
				 ( SELECT 1
				     FROM ##biml__dim_table_merge_config_Standard dtms  -- only import if used
					WHERE [server_name] = dd.[server_name]
					  AND dtms.[stg_database] = dd.[database_name]
				 )


---------------------------------------------------------[etl].[dim_table]

		INSERT INTO [etl].[dim_table]
				   ([server_name]
				   ,[database_name]
				   ,[table_schema]
				   ,[table_name]
			...
			SELECT [server_name]
				  ...
				  ,[has_primary_key]
				  ,[enable_change_tracking]
			  FROM ##etl__dim_table dt
			 WHERE NOT EXISTS
				 ( SELECT 1
				     FROM [etl].[dim_table]
					WHERE [server_name] = dt.[server_name]
					  AND [database_name] = dt.[database_name]
					  AND [table_schema] = dt.[table_schema]
			   ...
			   AND EXISTS
				 ( SELECT 1
				     FROM ##biml__dim_table_merge_config_Standard dtms  -- only import if used
					WHERE [server_name] = dt.[server_name]
					  AND dtms.[stg_database] = dt.[database_name]
					  AND dtms.[stg_schema] = dt.[table_schema]
					  AND dtms.[stg_table] = dt.[table_name]
				 )


---------------------------------------------------------[etl].[dim_column]

		INSERT INTO [etl].[dim_column]
				   ([server_name]
				   ,[database_name]
				   ,[table_schema]
				   ,[table_name]
			...
			SELECT [server_name]
				  ...
				  ,[primary_key]
				  ,[merge_type]
			  FROM ##etl__dim_column dc
			 WHERE NOT EXISTS
				 ( SELECT 1
				     FROM [etl].[dim_column]
					WHERE [server_name] = dc.[server_name]
					  AND [database_name] = dc.[database_name]
					  AND [table_schema] = dc.[table_schema]
					  AND [table_name] = dc.[table_name]
					  AND [column_name] = dc.[column_name]
				 )
			   AND EXISTS
				 ( SELECT 1
				     FROM ##biml__dim_table_merge_config_Standard dtms  -- only import if used
					WHERE [server_name] = dc.[server_name]
					  AND dtms.[stg_database] = dc.[database_name]
					  AND dtms.[stg_schema] = dc.[table_schema]
					  AND dtms.[stg_table] = dc.[table_name]
				 )
...
DROP TABLE #dim_table_merge_config__inserts;

PRINT 'Project Import Complete!'

SELECT @return_code AS [return code], @error_message AS [error message];
GO
/****** Object:  StoredProcedure [jtts].[Json Table Export]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Modify date: 03 Jun 2019 - Removed 'File Table' option
--
...
IF @use_file_table != 'N'
	BEGIN
		SET @error_message = 'File Table option is no longer supported'
		SELECT @return_code AS [return code], @error_message AS [error message]
		RETURN
	END
...
/* save in local table: [jtts].[json_repository] */
...
GO
/****** Object:  StoredProcedure [jtts].[Json Table Import]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
IF @use_file_table != 'N'
	BEGIN
		SET @error_message = 'File Table is no longer supported'
		SELECT @return_code AS [return code], @error_message AS [error message]
		RETURN
	END
...
SELECT @return_code AS [return code], @error_message AS [error message];
GO
/****** Object:  StoredProcedure [jtts].[Load JSON File]    Script Date: 6/3/2019 3:32:05 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE PROCEDURE [jtts].[Load JSON File]
	(
		 @label NVARCHAR(16),
		 @server_name NVARCHAR(128),
		 @database_name NVARCHAR(128),
...
DELETE FROM [jtts].[json_repository] 
 WHERE [label] = @label
   AND [server_name] = @server_name
   AND [database_name] = @database_name

INSERT [jtts].[json_repository]     
     ( [label]
     , [server_name]
     , [database_name]
     , [create_datetime]
...
SELECT @label AS [label]
     ...
     , @label_notes AS [label_notes]
     , @text_file AS [json_file]
